...
namespace SalaryPlanner
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void CalculateButton_Click(object sender, System.EventArgs e)
        {
            ...
            grossIncomeTextView.Text = annualIncome.ToString("#,##") + " Kr.";
            workSummaryTextView.Text = annualWorkHourSummary.ToString("#,##") + " Timer";
            taxPayableTextView.Text = taxPayable.ToString("#,##") + " Kr.";
            annualSavingsTextView.Text = annualSavings.ToString("#,##") + " Kr.";
            spendableIncomeTextView.Text = spendableIncome.ToString("#,##") + " Kr.";
